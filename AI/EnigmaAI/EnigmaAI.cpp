...
void CEnigmaAI::init(shared_ptr<CBattleCallback> CB)
{
...
BattleAction CEnigmaAI::activeStack(const CStack * stack)
{
...
void CEnigmaAI::actionFinished(const BattleAction &action)
{
	print("actionFinished called");
}

void CEnigmaAI::actionStarted(const BattleAction &action)
{
	print("actionStarted called");
}

void CEnigmaAI::battleAttack(const BattleAttack *ba)
{
	print("battleAttack called");
}

void CEnigmaAI::battleStacksAttacked(const std::vector<BattleStackAttacked> & bsa)
{
	print("battleStacksAttacked called");
}

void CEnigmaAI::battleEnd(const BattleResult *br)
{
	print("battleEnd called");
}

void CEnigmaAI::battleNewRoundFirst(int round)
{
	print("battleNewRoundFirst called");
}

void CEnigmaAI::battleNewRound(int round)
{
	print("battleNewRound called");
}

void CEnigmaAI::battleStackMoved(const CStack * stack, std::vector<BattleHex> dest, int distance)
{
	print("battleStackMoved called");;
}

void CEnigmaAI::battleSpellCast(const BattleSpellCast *sc)
{
	print("battleSpellCast called");
}

void CEnigmaAI::battleStacksEffectsSet(const SetStackEffect & sse)
{
	print("battleStacksEffectsSet called");
}

void CEnigmaAI::battleStart(const CCreatureSet *army1, const CCreatureSet *army2, int3 tile, const CGHeroInstance *hero1, const CGHeroInstance *hero2, bool Side)
{
	print("battleStart called");
	side = Side;
}

void CEnigmaAI::battleStacksHealedRes(const std::vector<std::pair<ui32, ui32> > & healedStacks, bool lifeDrain, bool tentHeal, si32 lifeDrainFrom)
{
	print("battleStacksHealedRes called");
}

void CEnigmaAI::battleNewStackAppeared(const CStack * stack)
{
	print("battleNewStackAppeared called");
}

void CEnigmaAI::battleObstaclesRemoved(const std::set<si32> & removedObstacles)
{
	print("battleObstaclesRemoved called");
}

void CEnigmaAI::battleCatapultAttacked(const CatapultAttack & ca)
{
	print("battleCatapultAttacked called");
}

void CEnigmaAI::battleStacksRemoved(const BattleStacksRemoved & bsr)
{
	print("battleStacksRemoved called");
}

void CEnigmaAI::print(const std::string &text) const
{
    logAi->traceStream() << "CEnigmaAI [" << this <<"]: " << text;
}

BattleAction CEnigmaAI::goTowards(const CStack * stack, BattleHex destination)
{
...
BattleAction CEnigmaAI::useCatapult(const CStack * stack)
{
...
void CEnigmaAI::attemptCastingSpell()
{
...
std::vector<BattleHex> CEnigmaAI::getTargetsToConsider( const CSpell *spell ) const
{
...
boost::optional<BattleAction> CEnigmaAI::considerFleeingOrSurrendering()
{
