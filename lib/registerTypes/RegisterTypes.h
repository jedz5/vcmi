...
void registerTypesClientPacks2(Serializer &s)
{
	...
	s.template registerType<CPackForClient, BattleForClient>();
	s.template registerType<BattleForClient, BattleNextRound>();
	s.template registerType<BattleForClient, BattleSetActiveStack>();
	s.template registerType<BattleForClient, BattleResult>();
	s.template registerType<BattleForClient, BattleStackMoved>();
	s.template registerType<BattleForClient, BattleStackAttacked>();
	s.template registerType<BattleForClient, BattleAttack>();
	s.template registerType<BattleForClient, StartAction>();
	s.template registerType<BattleForClient, EndAction>();
	s.template registerType<BattleForClient, BattleSpellCast>();
	s.template registerType<BattleForClient, SetStackEffect>();
	s.template registerType<BattleForClient, BattleTriggerEffect>();
	s.template registerType<BattleForClient, BattleObstaclePlaced>();
	s.template registerType<BattleForClient, BattleSetStackProperty>();
	s.template registerType<BattleForClient, StacksInjured>();
	s.template registerType<BattleForClient, BattleResultsApplied>();
	s.template registerType<BattleForClient, StacksHealedOrResurrected>();
	s.template registerType<BattleForClient, ObstaclesRemoved>();
	s.template registerType<BattleForClient, CatapultAttack>();
	s.template registerType<BattleForClient, BattleStacksRemoved>();
	s.template registerType<BattleForClient, BattleStackAdded>();
...
void registerTypesServerPacks(Serializer &s)
{
	...
	s.template registerType<CPackForServer, CbattleForServer>();
	s.template registerType<CbattleForServer, MakeAction>();
	s.template registerType<CbattleForServer, MakeCustomAction>();
